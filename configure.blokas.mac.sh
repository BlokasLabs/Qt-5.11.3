...
${QTDIR}/configure -prefix ${PREFIX} -debug-and-release -platform macx-clang -opensource -confirm-license -nomake tests -nomake examples -no-openssl --verbose \
	...
	-no-feature-cups -no-feature-fontdialog -no-feature-datawidgetmapper -no-feature-imageformat_bmp -no-feature-imageformat_ppm -no-feature-imageformat_xbm \
	-no-feature-imageformat_png -no-feature-imageformat_jpeg -no-feature-image_text -no-feature-colornames -no-feature-cups -no-feature-paint_debug -no-feature-freetype \
	...
	-no-feature-bearermanagement -skip qttools
