...
PREFIX=/opt/Qt-5.11.3-arm64e-blokas

${QTDIR}/configure -prefix ${PREFIX} -debug-and-release -platform macx-clang-arm64e -opensource -confirm-license -nomake tests -nomake examples -no-openssl --verbose \
